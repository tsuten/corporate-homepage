const AboutUs = () => {
  ...
  return (
    <section id="about-us" className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
...
ITによる効率化と、現場で培った確かな技術力。その両輪で、変化し続ける社会のニーズに応え、より豊かな未来の基盤を築いていきます。</p>
      <ul className="mx-auto grid max-w-6xl list-none grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
        {items.map((item) => (
